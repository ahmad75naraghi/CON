...
تاریخ: ۲۰۲۶-۰۹-۰۷ (به‌روزرسانی v1.0.1 — فیکس چیدمان پیشنهادها + بازنویسی کامل CSS بدون تیلویند) · محیط: PHP واقعی 8.2.29 (php-wasm) + شبیه‌ساز وردپرس/wpdb · فایل‌های عینی افزونه اجرا می‌شوند

## نتیجه نهایی: ✅ ۷۲۰ تست پاس — ۰ خطا (+ لینت PHP ۱۵/۱۵)
