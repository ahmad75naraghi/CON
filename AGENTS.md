...
- اگر اسکیمای دیتابیس تغییر می‌کند، Migration/SQL و مستند مربوطه را هم به‌روزرسانی کنید.
...
- پیشنهادهای مسیر راهنمایی از `Prepared_Server_Offers` خوانده می‌شوند، اما امتیازدهی و Ruleهای انتخاب هنوز باید با منطق تجاری دقیق‌تر شوند.
